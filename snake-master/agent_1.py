...
class DQN:
    ...
    def build_model(self):
        if os.path.exists('snake_mode-m') or os.path.exists('snake_mode-w'):
            print("Loading model from 'snake_model' ... ")
            model = keras.models.load_model("snake_mode")
            model.summary()
            #with open("snake_model-m.json",'r') as json_file:
            #    loaded_json_model = json_file.read()
            #model = keras.models.model_from_json(loaded_json_model)
            #model.load_weights("snake_mode-w")
...
def train_dqn(episode, env):
    ...
    for e in range(episode):
        ...
        model_chekcpoint = agent.model.call
        #model_json = agent.model.to_json()
        #with open("snake_model-m.json",'w') as json_file:
        #    json_file.write(model_json)
        #agent.model.save_weights("snake_model-w.h5")
